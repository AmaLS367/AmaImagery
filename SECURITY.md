...
- artifact or file exposure issues
- SSRF, traversal, command execution, or injection paths
- secrets disclosure
- provider abuse or prompt abuse with security impact
...
Good reports are precise, private, and reproducible. That is enough to start well.
