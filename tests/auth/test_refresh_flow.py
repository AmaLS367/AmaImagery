...
def test_refresh_flow_end_to_end():
    ...
    # 2) Нормальный refresh → новый access и новая кука (ротация)
    ...
    # 5) Logout: валидируем серверный ревок RT на новом клиенте
